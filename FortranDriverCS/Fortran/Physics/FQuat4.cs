...
namespace JA.Fortran.Physics
{
        ...
        IEquatable<FQuat4>
    {
        ...
        public static FQuat4 FromScalar(double scalar)
            => quat4_from_scalar(scalar);
        public static FQuat4 FromScalarVector(in FVector3 vector)
            => quat4_from_vec3(vector);
        public static FQuat4 FromScalarVector(double scalar, in FVector3 vector)
        ...
        #region Properties
        public ref double W => ref _data[0];
        public ref double X => ref _data[1];
        public ref double Y => ref _data[2];
        public ref double Z => ref _data[3];
        ...
        public readonly FMatrix6 RotateDiagonal(double[] diag, bool inverse = false) => quat4_rotate_diag(this, diag, inverse);

        public readonly double[] ToArray()
        {
            double[] data = new double[4];
            call_quat4_to_array(this, data);
            return data;
        }
        ...
        public string ToString(string formatting, IFormatProvider formatProvider)
        {
            ...
            {
                string sw = Math.Round(W, HelperFunctions.RoundDigits).ToString<double>(formatting, formatProvider);
                string vx = Math.Round(X, HelperFunctions.RoundDigits).ToString<double>(formatting, formatProvider);
                string vy = Math.Round(Y, HelperFunctions.RoundDigits).ToString<double>(formatting, formatProvider);
                string vz = Math.Round(Z, HelperFunctions.RoundDigits).ToString<double>(formatting, formatProvider);
...
#pragma warning restore IDE0057 // Use range operator
        ...
        #region Algebra
        public static FQuat4 Negate(FQuat4 a) => neg_quat4(a);
        public static FQuat4 Scale(double s, FQuat4 a) => mul_scalar_quat4(s, a);
        public static FQuat4 Scale(FQuat4 a, double s) => mul_quat4_scalar(a, s);
        public static FQuat4 Divide(FQuat4 a, double s) => div_quat4_scalar(a, s);
        ...
        public static double Dot(FQuat4 a, FQuat4 b) => dot_quat4_quat4(a, b);
        ...
        public static FQuat4 operator *(double f, FQuat4 a) => Scale(a, f);
        public static FQuat4 operator /(FQuat4 a, double d) => Divide(a, d);
        ...
        internal static extern FQuat4 quat4_from_scalar(double scalar);
        [DllImport(libraryName, EntryPoint = "quat4_from_vec3", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern FQuat4 quat4_from_vec3(in FVector3 vector);
        ...
        [DllImport(libraryName, EntryPoint = "quat4_from_array", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern FQuat4 quat4_from_array(double[] values);
        ...
        [DllImport(libraryName, EntryPoint = "neg_quat4", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern FQuat4 neg_quat4(in FQuat4 a);
        ...
        [DllImport(libraryName, EntryPoint = "mul_quat4_scalar", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern FQuat4 mul_quat4_scalar(in FQuat4 a, double b);
        ...
        [DllImport(libraryName, EntryPoint = "div_quat4_scalar", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern FQuat4 div_quat4_scalar(in FQuat4 a, double b);
        [DllImport(libraryName, EntryPoint = "dot_quat4_quat4", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern double dot_quat4_quat4(in FQuat4 a, in FQuat4 b);
        ...
        internal static extern FMatrix6 quat4_rotate_diag(in FQuat4 q, double[] diag, bool inverse);
        ...
        [DllImport(libraryName, EntryPoint = "call_quat4_to_array", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void call_quat4_to_array(in FQuat4 a, [Out] double[] b);
