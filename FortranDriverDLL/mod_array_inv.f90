...
implicit none
    ...
    interface det
        module procedure :: determinant_array_m
    end interface
    interface inv
        module procedure :: inverse_array_m
    end interface
    interface solve
    ...
    integer :: n, m
        ...
        case(1)  
            d = A(1,1)
        case(2)
            d = determinant_array2(A)
        case(3)
            d = determinant_array3(A)
        case(4)
            d = determinant_array4(A)
        case default
            d = determinant_lu(A)
        end select
    end function
    ...
    pure function determinant_array2(A) result(d)
    ...
    pure function inverse_array2(A, d_known) result(A_inv)
    real(real64), intent(in) :: A(2,2)        
    ...
    pure function determinant_array3(A) result(d)
    implicit real(real64) (T)
    real(real64) :: d
    ...
    pure function inverse_array3(A, d_known) result(B)
    real(real64), intent(in) :: A(3,3)
    real(real64), intent(in), optional :: d_known
    ...
    pure function determinant_array4(A) result(d)
    implicit real(real64) (T)
    real(real64) :: d
    ...
    pure function inverse_array4(A, d_known) result(A_inv)
    ...
    pure function array5_inv(A) result(A_inv)
    ...
    pure function inverse_array6(A) result(A_inv)
    ...
    pure function determinant_lu(A) result(d)
    real(real64), intent(in) :: A(:,:)
    real(real64) :: d
    integer :: n
        n = size(A,1)
        ...
        d = determinant_lu_fix(n, A)
    end function
    
    pure function determinant_lu_fix(n, A) result(d)
    use mod_lu
    integer, intent(in) :: n
    ...
    pure function inverse_lu(A) result(A_inv)
    real(real64), intent(in) :: A(:,:)
    ...
    integer :: n
        ...
        A_inv = inverse_lu_fix(n, A)
            
    end function
    pure function inverse_lu_fix(n, A) result(A_inv)
    use mod_lu
    integer, intent(in) :: n
    real(real64), intent(in) :: A(n,n)
