    ...
    do i = 1, 5
        ...
        write ( *, '(a)' ) ''
        call quat_trans_print ( q1, '  q1 = quat_normal_01 ( seed ):' )
        call quat_trans_print ( q2, '  q2 = quat_conjugate ( q1 ):  ' )
    ...
    do i = 1, 5
        ...
        write ( *, '(a)' ) ''
        call quat_trans_print ( q1, '  q1 = quat_normal_01 ( seed ):' )
        call quat_trans_print ( q2, '  q2 = quat_exponentiate ( q1 ):' )

    end do

    return
    end
    subroutine quat_inv_test ( )
    ...
    do i = 1, 5
        ...
        write ( *, '(a)' ) ''
        call quat_trans_print ( q1, '  q1 = quat_normal_01 ( seed ):' )
        call quat_trans_print ( q2, '  q2 = quat_inverse ( q1 ):    ' )
        call quat_trans_print ( q3, '  q3 = quat_multiply ( q1, q2 ):    ' )
    ...
    do i = 1, 5
        ...
        write ( *, '(a)' ) ''
        call quat_trans_print ( q1, '  q1 = quat_normal_01 ( seed ) :' )
        call quat_trans_print ( q2, '  q2 = quat_normal_01 ( seed ) :' )
        call quat_trans_print ( q3, '  q3 = quat_multiply ( q1, q2 ):' )
    ...
    do i = 1, 5
        ...
        call quat_trans_print ( q1, '  q1 = quat_normal_01 ( seed )  :' )
        call quat_trans_print ( q2, '  q2 = quat_normal_01 ( seed )  :' )
        call quat_trans_print ( q3, '  q3 = quat_multiply2 ( q1, q2 ):' )
    ...
    do i = 1, 5
        write ( *, '(a)' ) ''
        call quat_normal_01 ( seed, q )
        call quat_trans_print ( q, '  q = quat_normal_01(seed):' )
        value = quat_norm ( q )
    ...
    subroutine quat_trans_print_test ( )
    ...
    call quat_trans_print ( q, '  The quaternion:' )
