    ...
    module procedure dot_vec2_vec2
    module procedure dot_mat2_mat2
    end interface
    ...
    interface det
    module procedure :: det_mat2
    end interface
    interface inv
    module procedure :: inv_mat2
    end interface
    interface solve
    ...
    pure function trans_mat2(a) result(t) bind(c)
    !dec$ attributes dllexport :: trans_mat2
    type(matrix2), intent(in) :: a
    type(matrix2) :: t
    ...
    pure function det_mat2(a) result(d) bind(c)
    !dec$ attributes dllexport :: det_mat2
    type(matrix2), intent(in) :: a
    real(real64) :: d
    d = det(a%data)
    end function
    pure function dot_mat2_mat2(w, m) result(u) bind(c)
    !dec$ attributes dllexport :: dot_mat2_mat2
    type(matrix2), intent(in) :: w
    type(matrix2), intent(in) :: m
    type(matrix2) :: u
    u%data = matmul(transpose(w%data), m%data)
    end function
    pure function inv_mat2(a) result(b) bind(c)
    !dec$ attributes dllexport :: inv_mat2
    type(matrix2), intent(in) :: a
    type(matrix2) :: b
    b%data = inv(a%data)
    end function
    ...
    pure function dot_vec2_vec2(a,b) result(s) bind(c)
    !dec$ attributes dllexport :: dot_vec2_vec2
    type(vector2), intent(in) :: a, b
    real(real64) :: s
